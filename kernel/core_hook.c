		     ...
		     unsigned long arg4, unsigned long arg5)
{
	...
	if (current_uid_val == 0) {
		...
		if (arg2 == CMD_SUSFS_ADD_SUS_PATH) {
			int error = 0;
			if (!__range_ok((void __user*)arg3, sizeof(struct st_susfs_sus_path))) {
				pr_err("susfs: CMD_SUSFS_ADD_SUS_PATH -> arg3 is not accessible\n");
				return 0;
			}
			if (!__range_ok((void __user*)arg5, sizeof(error))) {
		...
		if (arg2 == CMD_SUSFS_ADD_SUS_MOUNT) {
			int error = 0;
			if (!__range_ok((void __user*)arg3, sizeof(struct st_susfs_sus_mount))) {
		...
		if (arg2 == CMD_SUSFS_ADD_SUS_KSTAT) {
			int error = 0;
			if (!__range_ok((void __user*)arg3, sizeof(struct st_susfs_sus_kstat))) {
		...
		if (arg2 == CMD_SUSFS_ADD_TRY_UMOUNT) {
			int error = 0;
			if (!__range_ok((void __user*)arg3, sizeof(struct st_susfs_try_umount))) {
		...
		if (arg2 == CMD_SUSFS_SET_UNAME) {
			int error = 0;
			if (!__range_ok((void __user*)arg3, sizeof(struct st_susfs_uname))) {
		...
		if (arg2 == CMD_SUSFS_SET_CMDLINE_OR_BOOTCONFIG) {
			int error = 0;
			if (!__range_ok((void __user*)arg3, SUSFS_FAKE_CMDLINE_OR_BOOTCONFIG_SIZE)) {
		...
		if (arg2 == CMD_SUSFS_ADD_OPEN_REDIRECT) {
			int error = 0;
			if (!__range_ok((void __user*)arg3, sizeof(struct st_susfs_open_redirect))) {
		...
		if (arg2 == CMD_SUSFS_SHOW_VERSION) {
			...
			if (!__range_ok((void __user*)arg3, len_of_susfs_version+1)) {
		...
		if (arg2 == CMD_SUSFS_SHOW_ENABLED_FEATURES) {
			...
			if (!__range_ok((void __user*)arg3, sizeof(u64))) {
		...
		if (arg2 == CMD_SUSFS_SHOW_VARIANT) {
			...
			if (!__range_ok((void __user*)arg3, len_of_variant+1)) {
